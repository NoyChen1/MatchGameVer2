...
class GameController: UIViewController {
    ...
    func initCards(numOfRows : Int, numOfCardsPerRow : Int){
        ...
        let images = [#imageLiteral(resourceName: "emoji7"),#imageLiteral(resourceName: "emoji8"),#imageLiteral(resourceName: "emoji5"),#imageLiteral(resourceName: "emoji4"),#imageLiteral(resourceName: "emoji1"),#imageLiteral(resourceName: "emoji2"),#imageLiteral(resourceName: "emoji10"),#imageLiteral(resourceName: "emoji2"),#imageLiteral(resourceName: "emoji3"),#imageLiteral(resourceName: "emoji14")]
        var count:Int = 0
